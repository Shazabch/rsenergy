    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('notes')
            ->addColumn('amount')
            ->addColumn('category_id',function(expense $model){
                return (!empty($model->expense_category) ? $model->expense_category->name : 'Null');
            })
            ->addColumn('employee_id',function(expense $model){
            ...
            ->addColumn('updated_at_formatted', function(expense $model) { 
